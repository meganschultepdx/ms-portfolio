	...
	return (
		<Router>
			<div className="projects">
				...
				<Link to="/stephenkingdom" className="kingdomLink">
					<img
						src={stephenkingdom}
				...
				<p className="aboutProject">
					This was an internal company tool created during a five week
					internship. The back-end is built as an independent API with C#/EF
					Core/Sqlite; the front-end is built in React with Hooks and Typescript
					and makes get
				</p>
				<a
				...
				<p className="aboutProject">
					...
					weather for three main surf spots on the Oregon coast. It prpovides
					only the most essential information needed to decide whether the
					conditions are good for surfing at that particular location at that
					particular time
				</p>
				<a
				...
				<p className="aboutProject">
					...
					and meals across Portland, OR. As such, we call it "Free Food Finder
					PDX" (FFF-PDX). The landing page displays the FFF-PDX logo, a menu bar
					and a
				</p>
				<a
